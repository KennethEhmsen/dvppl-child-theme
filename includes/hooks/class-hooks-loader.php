		...
		function dvppl_hooks_customize_register( $wp_customize ) {
			...
			$wp_customize->add_section(
				'header-hooks-section', array(
					'title'    => __( 'Header', 'dvppl-child-theme' ),
					'panel'    => 'dvppl-panel-hooks',
				)
			);

			$wp_customize->add_section(
				'single-hooks-section', array(
					'title'    => __( 'Single', 'dvppl-child-theme' ),
					'panel'    => 'dvppl-panel-hooks',
				)
			);
			...
			$wp_customize->add_section(
				'footer-hooks-section', array(
					'title'    => __( 'Footer', 'dvppl-child-theme' ),
					'panel'    => 'dvppl-panel-hooks',
				)
			);
			...
			$wp_customize->add_control( 'hook_et_head_meta', array(
				...
				'label'       => __( 'Head Meta', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_wp_head', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'wp_head', 'dvppl-child-theme' ),
				)
			);
			...
			$wp_customize->add_control( 'hook_et_html_top_header', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'Top Header ( et_html_top_header )', 'dvppl-child-theme' ),
				)
			);
			...
			$wp_customize->add_control( 'hook_et_html_slide_header', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'Slide Header ( et_html_slide_header )', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_et_html_logo_container', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'Logo Container ( et_html_logo_container )', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_et_header_top', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'Top Navigation ( et_header_top )', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_et_before_main_content', array(
				'type'        => 'textarea',
				'section'     => 'header-hooks-section',
				'label'       => __( 'After Header ( et_before_main_content )', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_et_before_content', array(
				...
				'label'       => __( 'Before Content ( et_before_content )', 'dvppl-child-theme' ),
			...
			$wp_customize->add_control( 'hook_et_after_main_content', array(
				...
				'label'       => __( 'Before Footer ( et_after_main_content )', 'dvppl-child-theme' ),
